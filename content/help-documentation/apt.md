...
The three components of the APT include a metadata model, front-end tool and supporting content database and dashboard, and a document repository. First, within APT the ATBDs are structured metadata and not just documents. This means that component metadata is reusable across different ATBDs, which promotes consistency and standardization while reducing human input. For example, within APT authors are encouraged to use existing data, such as citation information, instead of manually inputting this information into an ATBD. This reduces the potential for errors. Also, data products and source code are often dynamic, yet it is difficult to update static documents. Another benefit of the metadata model is that it makes the content dynamic so that it is easier to update ATBDs. Finally, the metadata model provides users with ATBDs in machine readable formats which increases the discoverability of these documents.

The second component of the APT is the database and front-end tool. ATBD authors use the APT’s cloud-based authoring tool to write new documents and to edit existing documents. The front-end authoring tool guides users through the ATBD authoring process in a series of organized steps. This assists authors in providing the necessary content, reduces the need to organize and structure documents, and promotes standardization across ATBDs. Content entered into this tool is saved into a database with the structure defined by the ATBD metadata model. This database infrastructure supports the reuse of content across documents. Once created, the front-end user interface provides two options for viewing the documents, either HTML or PDF.

Currently, end users often find searching for and discovering existing ATBDs challenging. Thus, the final component of the APT is the establishment of a centralized repository and discovery portal. Searching for ATBDs through the repository utilizes both identifying metadata (e.g., reference information and science keywords) and document content (e.g., equations and scientific concepts). The repository and search capabilities increase the discoverability of ATBDs. Last, a future goal is to integrate existing NASA ATBDs into the centralized repository for easy access. Integration of all ATBDs will increase the search and discoverability of not only new ATBDs but previous ones as well.

## 2. The Algorithm Publication Tool

This section provides explanations of the various features of APT and describes the process of authoring, searching, and discovering documents and content through the centralized ATBD repository.

### 2.1 Main Landing Page and User Login

The main landing page is open to all users (Figure 2). Users can ask questions or provide feedback by clicking on Feedback in the navigation bar.  Authorized users can sign in by clicking “Sign in”. New authors should click the Sign In to find a link to initiate sign up for an account.

![Figure 2](https://github.com/bwbaker1/APT_Images/blob/master/figure2_annotation.png?raw=true "Overview of APT’s landing page. Outlined and labelled pages and features correspond to the numbered descriptions in text below. NASA APT – Persistent button which redirects users to the APT landing page.")
...
3. **Documents** – This button redirects users to the APT Documents Dashboard that lists all completed and publicly available ATBDs. 
4. **About** – This button redirects users to the About page that describes APT and has FAQs.
5. **User Guide** – This button redirects users to the APT User Guide and the LaTeX guide.
6. **Feedback** – This button provides a form so users can submit feedback about APT or ask a question (see Figure 3). 
7. **Sign in** – This button redirects authorized users to the APT’s sign in page. New users can create an account from that page.
...
3. **Name** – Provide first and last name.
4. **Email** – Enter your email address so that the APT team can contact you if needed.
5. **Attachment** – Use this button to attach a file (note: only specific file types are allowed).
6. **I’m not a robot** – Checking the box “I’m not a robot” distinguishes between humans and bots and helps protect APT from spam and abuse.
7. **Submit** – Click this button to submit your feedback to the APT team. 

Any users can navigate to the APT document page and can search for and view published ATBDs. However, only authorized and authenticated users can create or edit an ATBD. To get authorized, users must first create an account (Figure 4). APT uses Amazon Web Services Cognito for authorization and authentication. Once the account is created, a notification will be sent to the APT curator who will then authorize the user in Cognito. After approval, the user must sign in (Figure 5) to create a new ATBD or to view and edit ATBDs that they are associated with.

![Figure 4](https://github.com/bwbaker1/APT_Images/blob/master/figure4_annotation.png?raw=true "Prompt to create a new account with APT. Items outlined in red correspond to the numbered descriptions in the text below.")

1. **Email** – Enter the full email address that will be associated with the new APT account.
2. **Preferred username** – Enter the preferred username for the account that others will see in communication threads and 
...
![Figure 5](https://github.com/bwbaker1/APT_Images/blob/master/figure5_annotation.png?raw=true "The APT’s sign in page. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 7](https://github.com/bwbaker1/APT_Images/blob/master/figure7_annotation.png?raw=true " User dashboard lead author tab. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 8](https://github.com/bwbaker1/APT_Images/blob/master/figure8_annotation.png?raw=true "User dashboard contributions author tab. Outlined and labeled feature corresponds to the numbered descriptions in text below. See figure 7 for a detailed description of all features.")
...
![Figure 9](https://github.com/bwbaker1/APT_Images/blob/master/figure9_annotation.png?raw=true "User dashboard reviews tab. See figure 7 for a detailed description of all features.")
...
![Figure 10](https://github.com/bwbaker1/APT_Images/blob/master/figure10_annotation.png?raw=true "User dashboard public tab. See figure 7 for a detailed description of all features.")
...
![Figure 11](https://github.com/bwbaker1/APT_Images/blob/master/figure11_annotation.png?raw=true "The APT’s Contacts page. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 12](https://github.com/bwbaker1/APT_Images/blob/master/figure12_annotation.png?raw=true "Figure 12 Create a new contact. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 14](https://github.com/bwbaker1/APT_Images/blob/master/figure14_annotation.png?raw=true "Figure 14 Creating or editing an ATBD. Users can create new ATBDs or edit existing ATBDs that they are associated with. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 16](https://github.com/bwbaker1/APT_Images/blob/master/figure16_annotation.png?raw=true "Figure 16 ATBD viewing and editing modes. Outlined and labeled pages and features correspond to the numbered descriptions in text below.")
...
![Figure 17](https://github.com/bwbaker1/APT_Images/blob/master/figure17_annotation_test.png?raw=true "Figure 17 Navigation feature associated with creating an ATBD. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 19a](https://github.com/bwbaker1/APT_Images/blob/master/figure19a_annotation.png?raw=true "Figure 19a ATBD unique identifying information. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 19b](https://github.com/bwbaker1/APT_Images/blob/master/figure19b_annotation.png?raw=true "Figure 19b Comments section. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 20](https://github.com/bwbaker1/APT_Images/blob/master/figure20_annotation.png?raw=true "Figure 20 ATBD citation information. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 21](https://github.com/bwbaker1/APT_Images/blob/master/figure21_annotation.png?raw=true "Figure 21 Individual or group contact information. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 22](https://github.com/bwbaker1/APT_Images/blob/master/figure22_annotation.png?raw=true "Figure 22 Select or create a new contact. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 23](https://github.com/bwbaker1/APT_Images/blob/master/figure23_annotation.png?raw=true "Figure 23 Required and optional fields for creating a new ATBD contact (if type is “Person”). Outlined and labeled features correspond to numbered descriptions in text below.")

1. **Create new contact** – Dropdown menu that allows authors to select an existing contact or to create a new one.
2. **First Name** – Provide the first name of the contact person. (required field). Middle Name – Enter the middle name of the contact person.
...
![Figure 24](https://github.com/bwbaker1/APT_Images/blob/master/figure24_annotation.png?raw=true "Figure 24 Two options to add references to the ATBD. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 25](https://github.com/bwbaker1/APT_Images/blob/master/figure25_annotation.png?raw=true "Figure 25 Form to manually enter reference information. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 26](https://github.com/bwbaker1/APT_Images/blob/master/figure26_annotation.png?raw=true "Figure 26 Introduction to the ATBD. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 28](https://github.com/bwbaker1/APT_Images/blob/master/figure28_annotation.png?raw=true "Figure 28 Insert the scientific theory and assumptions associated with the algorithm. Outlined and labeled features correspond to the numbered descriptions in text below.")
...
![Figure 29](https://github.com/bwbaker1/APT_Images/blob/master/figure29_annotation.png?raw=true "Figure 29 Insert the mathematical theory and assumptions associated with the algorithm. Outlined and labeled features correspond to the numbered descriptions in text below.")
...
![Figure 30](https://github.com/bwbaker1/APT_Images/blob/master/figure30_annotation.png?raw=true "Figure 30 Add input and output variables used and generated by the algorithm. Outlined and labeled features correspond to the numbered descriptions in text below.")
...
![Figure 31](https://github.com/bwbaker1/APT_Images/blob/master/figure31_annotation.png?raw=true "Figure 31 Variable(s) that are used in the algorithm. Outlined and labeled features correspond to the numbered descriptions in the text below.")
...
![Figure 32](https://github.com/bwbaker1/APT_Images/blob/master/figure32_annotation.png?raw=true "Figure 32 Variable(s) that are generated by the algorithm. Outlined and labeled features correspond to the numbered descriptions in the text below.")
...
![Figure 33](https://github.com/bwbaker1/APT_Images/blob/master/figure33_annotation.png?raw=true "Figure 33 Limitations and constraints for using the output data derived by the algorithm. Outlined and labeled features correspond to numbered descriptions in text.")

1. **Describe the algorithm constraints** – Provide the constraints and limitations for using the algorithm output data.

![Figure 34](https://github.com/bwbaker1/APT_Images/blob/master/figure34_annotation.png?raw=true "Figure 34 Performance assessment of the algorithm. Outlined and labeled features correspond to numbered descriptions in text below.")
...
1. **URL** – URL – Provide an URL that directs users to the algorithm implementation source code.
...
![Figure 39](https://github.com/bwbaker1/APT_Images/blob/master/figure39_annotation.png?raw=true "Figure 39 ATBD abstract and journal details. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 40](https://github.com/bwbaker1/APT_Images/blob/master/figure40_annotation.png?raw=true "Figure 40 Discussion, Data availability, and acknowledgments. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 41](https://github.com/bwbaker1/APT_Images/blob/master/figure41.png?raw=true "Figure 41 The APT”s Rich Content Editor. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 42](https://github.com/bwbaker1/APT_Images/blob/master/figure42_annotation.png?raw=true "Figure 42 Insert tables using the rich content editor. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 43](https://github.com/bwbaker1/APT_Images/blob/master/figure43_annotation.png?raw=true "Figure 43 Upload images using the rich content editor. Outlined and labeled features correspond to numbered descriptions in text below.")
...
![Figure 44](https://github.com/bwbaker1/APT_Images/blob/master/figure44_annotation.png?raw=true "Figure 44 The APT’s elastic search feature allows users to search and locate archived ATBDs from the centralized repository. Outlined and labeled features correspond to numbered descriptions in text below.")
